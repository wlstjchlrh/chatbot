  ...
  return (
    <div className="relative">
      ...
      <button onClick={() => handleSend()}>
        <IconArrowUp className="absolute right-2 bottom-3 h-8 w-8 hover:cursor-pointer rounded-full p-1 bg-indigo-800 text-white hover:opacity-80 animate-bounce" />
      </button>
    </div>
  );
};
